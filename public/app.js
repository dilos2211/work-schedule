...
// Функция отображения статуса "Есть несохраненные изменения"
...
async function loadShiftsFromDB() {
  ...
  try {
    ...
    renderCalendar();
    statusMsg.style.display = 'none'; // Скрываем плашку при успешной загрузке из базы
  } catch (err) {
...
modalSaveBtn.addEventListener('click', () => {
  ...
  renderCalendar();
  markAsUnsaved(); // Предупреждаем, что данные изменились и не сохранены
});
